...
function bswp_setup() {
	 ...
	 */
	add_editor_style( array( 'css/editor-style.css', 'fonts/genericons.css', bswp_fonts_url() ) );
...
function bswp_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Main Widget Area', 'bswp' ),
		'id'            => 'sidebar-1',
		'description'   => __( 'Appears in the footer section of the site.', 'bswp' ),
	...
	register_sidebar( array(
		'name'          => __( 'Secondary Widget Area', 'bswp' ),
		'id'            => 'sidebar-2',
		'description'   => __( 'Appears on posts and pages in the sidebar.', 'bswp' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h3 class="widget-title">',
		'after_title'   => '</h3>',
