 ...
 */
function bswp_get_comment_author( $comment_ID = 0 ) {
 ...
 */
function bswp_comment_author( $comment_ID = 0 ) {
 ...
 */
function bswp_get_comment_author_email( $comment_ID = 0 ) {
	$comment = get_comment( $comment_ID );
 ...
 */
function bswp_comment_author_email( $comment_ID = 0 ) {
 ...
 */
function bswp_comment_author_email_link($linktext='', $before='', $after='') {
 ...
 * @param string $after The text or HTML to display after the email link.
 */
function bswp_get_comment_author_email_link($linktext='', $before='', $after='') {
	global $comment;
 ...
 */
function bswp_get_comment_author_link( $comment_ID = 0 ) {
 ...
 */
function bswp_comment_author_link( $comment_ID = 0 ) {
 ...
 */
function bswp_get_comment_author_IP( $comment_ID = 0 ) {
	$comment = get_comment( $comment_ID );
 ...
 */
function bswp_comment_author_IP( $comment_ID = 0 ) {
 ...
 * @return string
 */
function bswp_get_comment_author_url( $comment_ID = 0 ) {
	$comment = get_comment( $comment_ID );
 ...
 */
function bswp_comment_author_url( $comment_ID = 0 ) {
 ...
 */
function bswp_get_comment_author_url_link( $linktext = '', $before = '', $after = '' ) {
 ...
 * @param string $after The text or HTML to display after the email link.
 */
function bswp_comment_author_url_link( $linktext = '', $before = '', $after = '' ) {
 ...
 */
function bswp_comment_class( $class = '', $comment_id = null, $post_id = null, $echo = true ) {
 ...
 */
function bswp_get_comment_class( $class = '', $comment_id = null, $post_id = null ) {
 ...
 */
function bswp_get_comment_date( $d = '', $comment_ID = 0 ) {
	$comment = get_comment( $comment_ID );
	if ( '' == $d )
 ...
 */
function bswp_comment_date( $d = '', $comment_ID = 0 ) {
 ...
 */
function bswp_get_comment_excerpt( $comment_ID = 0 ) {
	$comment = get_comment( $comment_ID );
 ...
 */
function bswp_comment_excerpt( $comment_ID = 0 ) {
 ...
 */
function bswp_get_comment_link( $comment = null, $args = array() ) {
 ...
 */
function bswp_get_comments_link($post_id = 0) {
 ...
 */
function bswp_comments_link( $deprecated = '', $deprecated_2 = '' ) {
	if ( !empty( $deprecated ) )
 ...
 */
function bswp_get_comments_number( $post_id = 0 ) {
 ...
 * @param string $deprecated Not used.
 */
function bswp_comments_number( $zero = false, $one = false, $more = false, $deprecated = '' ) {
	if ( !empty( $deprecated ) )
		_deprecated_argument( __FUNCTION__, '1.3' );
 ...
 */
function bswp_get_comment_text( $comment_ID = 0 ) {
	$comment = get_comment( $comment_ID );
 ...
 */
function bswp_comment_text( $comment_ID = 0 ) {
	$comment = get_comment( $comment_ID );
 ...
 */
function bswp_get_comment_time( $d = '', $gmt = false, $translate = true ) {
	global $comment;
 ...
 */
function bswp_get_comment_type( $comment_ID = 0 ) {
	$comment = get_comment( $comment_ID );
 ...
 */
function bswp_comment_type($commenttxt = false, $trackbacktxt = false, $pingbacktxt = false) {
 ...
 */
function bswp_get_trackback_url() {
 ...
 */
function bswp_trackback_url( $deprecated_echo = true ) {
 ...
 */
function bswp_trackback_rdf( $deprecated = '' ) {
	if ( !empty( $deprecated ) )
 ...
 */
function bswp_comments_open( $post_id = null ) {
 ...
 */
function bswp_pings_open( $post_id = null ) {
 ...
 */
function bswp_wp_comment_form_unfiltered_html_nonce() {
	$post = get_post();
 ...
 */
function bswp_comments_template( $file = '/comments.php', $separate_comments = false ) {
 ...
 */
function bswp_comments_popup_script($width=400, $height=400, $file='') {
 ...
 */
function bswp_comments_popup_link( $zero = false, $one = false, $more = false, $css_class = '', $none = false ) {
	global $wpcommentspopupfile, $wpcommentsjavascript;
 ...
 */
function bswp_get_comment_reply_link($args = array(), $comment = null, $post = null) {
	global $user_ID;
	...
	if ( get_option('comment_registration') && !$user_ID )
		...
		$link = "<a class='btn btn-sm btn-default comment-reply-link' href='" . esc_url( add_query_arg( 'replytocom', $comment->comment_ID ) ) . "#" . $respond_id . "' onclick='return addComment.moveForm(\"$add_below-$comment->comment_ID\", \"$comment->comment_ID\", \"$respond_id\", \"$post->ID\")'>$reply_text</a>";
 ...
 * @return string|bool|null Link to show comment form, if successful. False, if comments are closed.
 */
function bswp_comment_reply_link($args = array(), $comment = null, $post = null) {
	echo bswp_get_comment_reply_link($args, $comment, $post);
}
 ...
 * @return string|bool|null Link to show comment form, if successful. False, if comments are closed.
 */
function bswp_get_post_reply_link($args = array(), $post = null) {
	global $user_ID;
 ...
 * @return string|bool|null Link to show comment form, if successful. False, if comments are closed.
 */
function bswp_post_reply_link($args = array(), $post = null) {
 ...
 */
function bswp_get_cancel_comment_reply_link($text = '') {
	if ( empty($text) )
 ...
 * @param string $text Optional. Text to display for cancel reply link.
 */
function bswp_cancel_comment_reply_link($text = '') {
 ...
 */
function bswp_get_comment_id_fields( $id = 0 ) {
	if ( empty( $id ) )
		$id = get_the_ID();
 ...
 */
function bswp_comment_id_fields( $id = 0 ) {
 ...
 */
function bswp_comment_form_title( $noreplytext = false, $replytext = false, $linktoparent = true ) {
	global $comment;
 ...
 * @since 2.7.0
 */
class BSWP_Walker_Comment extends Walker {
	/**
...
?>
		...
		<div class="reply">
			<?php bswp_comment_reply_link( array_merge( $args, array( 'add_below' => $add_below, 'depth' => $depth, 'max_depth' => $args['max_depth'] ) ) ); ?>
		</div>
		<?php if ( 'div' != $args['style'] ) : ?>
		</div>
		<?php endif; ?>
<?php
	...
	protected function html5_comment( $comment, $depth, $args ) {
		$tag = ( 'div' === $args['style'] ) ? 'div' : 'li';
?>
		<<?php echo $tag; ?> id="comment-<?php comment_ID(); ?>" class="media" <?php comment_class( empty( $args['has_children'] ) ? '' : 'parent' ); ?>>
            <div class="pull-left">
			   <?php if ( 0 != $args['avatar_size'] ) echo get_avatar( $comment, $args['avatar_size'] ); ?>
            </div>
            <div class="media-body">
				<article id="div-comment-<?php comment_ID(); ?>" class="panel panel-default comment-body">
                    <div class="panel-heading">
				      	<div class="pull-right comment-metadata">
				      		<a href="<?php echo esc_url( get_comment_link( $comment->comment_ID ) ); ?>">
				      			<time datetime="<?php comment_time( 'c' ); ?>">
				      				<?php printf( _x( '%1$s at %2$s', '1: date, 2: time' ), get_comment_date(), get_comment_time() ); ?>
				      			</time>
				      		</a>
				      		<?php edit_comment_link( __( 'Edit' ), '<span class="btn btn-sm btn-default edit-link">', '</span>' ); ?>
				        	<?php bswp_comment_reply_link( array_merge( $args, array( 'add_below' => 'div-comment', 'depth' => $depth, 'max_depth' => $args['max_depth'] ) ) ); ?>
				      	</div><!-- .comment-metadata -->

				      	<div class="panel-title comment-author vcard">
				      		<?php printf( __( '%s <span class="text-muted says">says:</span>' ), sprintf( '<b class="fn">%s</b>', get_comment_author_link() ) ); ?>
				      	</div><!-- .comment-author -->
                    </div>
 ...
 */
function bswp_list_comments($args = array(), $comments = null ) {
	...
	if ( empty($walker) )
		$walker = new BSWP_Walker_Comment;
 ...
 * @return void"
 */
function bswp_comment_form( $args = array(), $post_id = null ) {
	if ( null === $post_id )
		$post_id = get_the_ID();
	else
		$id = $post_id;
	...
	$fields   =  array(
		'author' => '<div class="form-group comment-form-author">' . '<label for="author" class="col-lg-2 control-label">' . __( 'Name' ) . ( $req ? ' <span class="required">*</span>' : '' ) . '</label> ' .
		            '<div class="col-lg-10"><input id="author" name="author" type="text" class="form-control" value="' . esc_attr( $commenter['comment_author'] ) . '" size="30"' . $aria_req . ' /></div></div>',
		'email'  => '<div class="form-group comment-form-email"><label for="email" class="col-lg-2 control-label">' . __( 'Email' ) . ( $req ? ' <span class="required">*</span>' : '' ) . '</label> ' .
		            '<div class="col-lg-10"><input id="email" name="email" ' . ( $html5 ? 'type="email"' : 'type="text"' ) . ' class="form-control" value="' . esc_attr(  $commenter['comment_author_email'] ) . '" size="30"' . $aria_req . ' /></div></div>',
		'url'    => '<div class="form-group comment-form-url"><label for="url" class="col-lg-2 control-label">' . __( 'Website' ) . '</label> ' .
		            '<div class="col-lg-10"><input id="url" name="url" ' . ( $html5 ? 'type="url"' : 'type="text"' ) . ' class="form-control" value="' . esc_attr( $commenter['comment_author_url'] ) . '" size="30" /></div></div>',
	);

	$required_text = sprintf( ' ' . __('Required fields are marked %s'), '<span class="required">*</span>' );
	$defaults = array(
		'fields'               => apply_filters( 'comment_form_default_fields', $fields ),
		'comment_field'        => '<div class="form-group comment-form-comment"><label for="comment" class="col-lg-2 control-label">' . _x( 'Comment', 'noun' ) . '</label> <div class="col-lg-10"><textarea id="comment" name="comment" class="form-control" cols="45" rows="8" aria-required="true"></textarea></div></div>',
		...
		'logged_in_as'         => '<span class="logged-in-as">' . sprintf( __( 'Logged in as <a class="btn-link" href="%1$s">%2$s</a>. <a class="btn btn-sm btn-primary" href="%3$s" title="Log out of this account">Log out?</a>' ), get_edit_user_link(), $user_identity, wp_logout_url( apply_filters( 'the_permalink', get_permalink( $post_id ) ) ) ) . '</span>',
		'comment_notes_before' => '<div class="col-lg-offset-2 col-lg-10"><p class="comment-notes">' . __( 'Your email address will not be published.' ) . ( $req ? $required_text : '' ) . '</p></div>',
		'comment_notes_after'  => '<span class="form-allowed-tags">' . sprintf( __( 'You may use these <abbr title="HyperText Markup Language">HTML</abbr> tags and attributes: %s' ), ' <code>' . allowed_tags() . '</code>' ) . '</span>',
		'id_form'              => 'commentform',
		'id_submit'            => 'submit',
	...
	?>
		<?php if ( comments_open( $post_id ) ) : ?>
			...
			<div id="respond" class="panel-heading comment-respond">
				...
				<h3 class="panel-title comment-reply-title"><?php comment_form_title( $args['title_reply'], $args['title_reply_to'] ); ?> <small><?php cancel_comment_reply_link( $args['cancel_reply_link'] ); ?></small></h3>
            ...
            <div class="panel-body">
				...
				<?php else : ?>
					<form action="<?php echo site_url( '/wp-comments-post.php' ); ?>" method="post" id="<?php echo esc_attr( $args['id_form'] ); ?>" class="form form-horizontal comment-form"<?php echo $html5 ? ' novalidate' : ''; ?>>
				      <?php if ( !is_user_logged_in() ) : ?>
                        <fieldset>
